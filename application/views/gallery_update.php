...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-4">
<?php echo form_open_multipart('user/gallery_update') ; ?>
      <table class="table table-bordered table-striped">


        <tr>
          <th colspan="6"><h4 class="text-center">Gallery Image Info Update</h3></th>
	...
	value="<?php echo $gallery['id']; ?>"></th>
    </tr> 		
     <tr>
          <th>Image Name</th>
          <th><input type='text' id='name' name='name' value="<?php echo $gallery['image_name']; ?>"></th>
