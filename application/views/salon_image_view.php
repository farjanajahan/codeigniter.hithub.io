  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <table class="table table-bordered table-striped">
        ...
        <tr>
          <th colspan="6"><h4 class="text-center">Salon Images Info</h3></th>
...
<?php
	...
	foreach ($salon_image->result()as $row){
      echo "<tr>
	<th>$row->image_name</th><th>";
	?>
	<img src='<?php echo base_url(); ?>img/<?php print $row->image_name; ?>' height=50 width=50><th><a href="<?php echo 'salon_image_edit?id='.$row->id; ?>">Edit</a></th>
</tr> 
<?php
