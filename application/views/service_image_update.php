...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-4">
<?php echo form_open_multipart('user/service_image_update') ; ?>
	...
	value="<?php echo $service['id']; ?>"></th>
    </tr> 		
     <tr>
          <th>Image Name</th>
          <th><input type='text' id='name' name='name' value="<?php echo $service['image_name']; ?>"></th>
